               ...
               <div class="col-lg-8 offset-lg-2">
                     <div class="basic-login">
                        ...
                        <?php } ?>
                           ...
                           <input id="name" name="uname" type="text" placeholder="Enter username..." required />
                           ...
                           <button type="submit" class="e-btn e-btn-border w-100">Login Now</button>

                           <div class="or-divide"><span>or</span></div>
                           <a href="register.php" class="e-btn e-btn-black e-btn-black-2 w-100">Register Now</a>
                        </form>
